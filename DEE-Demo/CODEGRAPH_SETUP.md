# CodeGraph Demo (Dev) - Setup Guide

## Overview

CodeGraph Demo (Dev) is an AI-powered knowledge graph visualization tool built on Atlassian Forge. It uses Google's Gemini Flash API to analyze code files, extract semantic relationships, and build an interactive graph showing how different parts of your codebase connect.
...
React UI (CodeUpload.jsx)
    ↓
invoke('codegraph-demo-resolver', { path: '/analyze' })
    ↓
