(() => {
  ...
  // static/ui/bridge-shim.js
  var import_bridge = __toESM(require_out2(), 1);
  window.Forge = { invoke: import_bridge.invoke, getContext: import_bridge.getContext, requestJira: import_bridge.requestJira };
